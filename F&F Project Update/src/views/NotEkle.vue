<template>
  <form @submit.prevent="GirisYap" class="love-form">
    <h1>Yazı Ekle ❤️</h1>

    <label for="title">Başlık:</label>
    <input id="title" type="text" v-model="title" placeholder="Başlık girin..." required />

    <label for="details">Mesaj:</label>
    <textarea id="details" v-model="details" placeholder="Mesajın..." required></textarea>
...
export default {
  ...
  methods: {
    GirisYap() {
      console.log("Form Verisi:", this.title, this.details);
